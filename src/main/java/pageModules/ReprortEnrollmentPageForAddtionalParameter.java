...
public class ReprortEnrollmentPageForAddtionalParameter  extends BasicFunctions {
			...
			if (latestFile != null) {
				try (PDDocument document = PDDocument.load(latestFile)) {
					...
					for (int page = 1; page <= totalPages; page++) {
						 ...
						 * 
						 * processFourSubjectPatternPdf(Regno, latestFile, paper1, paper2, paper3,
						 * praticalExam, theoryExam, examTotal, subjectToFind,
						 * testCaseName,finalPaper1,finalPaper2); // Exit once the matching method is
						 * called return; }
						 */
				...
				if (subject.equalsIgnoreCase(subjectToFind)) {
					...
					try {
						if (finalTheoryMark == Paper1) {
							System.out.println(
									"Both Excel " + Paper1 + " and paper1 + paper2 " + finalTheoryMark + " for the following Register "
							...
							System.out.println("Both Excel " + Paper1 + " and paper1 + paper2 " + finalTheoryMark + " for the following "
									+ regno
									+ " data are not same please check Excel file or Pdf file for Theory Internal Sec Marks");
							testCaseScenario.log(Status.FAIL,
									"Both Excel " + Paper1 + " and paper1 + paper2 " + finalTheoryMark + " for the following " + regno
